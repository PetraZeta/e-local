...
<body>
        <div class="container-fluid">
                <div class="row vh-100">
                        ...
                        <!-- IZQUIERDA -->
                        <div class="section col-4" id="izquierda">
                                <div class="container ">
                                                        ...
                                                        <div class="row align-items-center my-5">
                                                                ...
                                                                <div class="col">
                                                                        <h3 class="text-center m-auto col">
                                                                                <a href="<?php echo BASE_URL; ?>Admon/caratula"><i class="fas fa-store"></i></a>
                                                                        </h3>
                                                                </div>
                                                                <div class="col">

                                                                        <h3 class="text-end m-3"><a href="<?php echo BASE_URL; ?>Login/caratula"> <i class="fas fa-sign-in-alt "></i></a></h3>
                                                                </div>
                        ...
                        <!-- DERECHA -->
                        <div class="section right col-8" id="derecha">
